...
Watch the project implementation walkthrough here:

[Video Implementation](https://drive.google.com/file/d/1ZUsSDDiKOJUdbjbzTDnrXaCLLPT-K07t/view?usp=drive_link)
...
_(This script reads the CSV and inserts the deals into the SQL table.)_
